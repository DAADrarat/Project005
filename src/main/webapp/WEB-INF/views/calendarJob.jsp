...
<head>
    ...
    <style>
        ...
        .policy-list a:hover { color: #1e3a8a; font-weight: bold; }
    ...
    <div class="inner">
        ...
        <div class="pc-tab">
            <ul class="tab-ul01">
                ...
                <li class="active"><a href="${pageContext.request.contextPath}/calendarJob.do"><span>채용공고일정</span></a></li>
            </ul>
        </div>
        ...
        <div class="policy-section">
            <div class="policy-left">
                <div>
                    ...
                    <ul class="policy-list">
                        <li>
                            <a href="https://www.example.com/job1" target="_blank">[삼성전자] 하반기 공채</a>
                            <input type="checkbox" value="[삼성전자] 하반기 공채">
                        </li>
                        <li>
                            <a href="https://www.example.com/job2" target="_blank">[토스] 핀테크 서비스 기획자</a>
                            <input type="checkbox" value="[토스] 핀테크 서비스 기획자">
                        </li>
                        <li>
                            <a href="https://www.example.com/job3" target="_blank">[네이버] 코딩테스트 일정</a>
                            <input type="checkbox" value="[네이버] 코딩테스트 일정">
                        </li>
                        <li>
                            <a href="https://www.example.com/job4" target="_blank">[카카오] 겨울 인턴십</a>
                            <input type="checkbox" value="[카카오] 겨울 인턴십">
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="policy-right">
                ...
                <button type="button" class="checkout-btn">선택한 공고 지원하기</button>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: [
                    { title: '[삼성전자] 2026 하반기 공채 서류접수', start: '2026-09-01', end: '2026-09-11' },
                    { title: '[토스] 핀테크 서비스 기획자 채용 마감', start: '2026-09-05' },
                    { title: '[당근] 백엔드 엔지니어 채용설명회', start: '2026-09-08' },
                    { title: '[네이버] 신입/경력 온라인 코딩테스트', start: '2026-09-12' },
                    { title: '[카카오] 2026 겨울 인턴십 서류접수', start: '2026-09-15', end: '2026-09-26' },
                    { title: '[우아한형제들] 프로덕트 디자이너 1차 면접', start: '2026-09-21', end: '2026-09-24' },
                    { title: '[현대자동차] R&D 부문 직무면접', start: '2026-09-25' },
                    { title: '[라인] 신입 기획자 최종 면접', start: '2026-09-28' },
                    { title: '[쿠팡] 백오피스 개발자 수시채용 마감', start: '2026-09-30' }
                ]
            });
